...
def main():
    ...
    normalize = transforms.Normalize(1.0, 1.0)
    scales = [0.75, 1.0, 1.25, 1.5, 1.75, 2.0]  #FAB
    num_classes = 21  #FAB
...
#            input = TV.to_tensor(image)     #FAB
#            input = TV.normalize(input, mean=1.0, std=1.0)       #FAB
#            input = input.unsqueeze(0)       #FAB
